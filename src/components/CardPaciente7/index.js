...
const CardPaciente7 = () => {
  ...
  return (
    <div>
      <C.Card>
        <div className='leito7' onClick={handleOpenModal}>
          <i className="fa-solid fa-hospital-user imagem-leito7"></i>
          <h2>Leito 7</h2>
        </div>
      </C.Card>
      ...
      {modalOpen && (
        <div className="modal-overlay7">
          <div className="modal7">
            <span className="close-button7" onClick={handleCloseModal}>
              &times;
            </span>
            <h1>Fábio Leon</h1>
