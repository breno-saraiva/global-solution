...
const CardPaciente8 = () => {
  ...
  return (
    <div>
      <C.Card>
        <div className='leito8' onClick={handleOpenModal}>
          <i className="fa-solid fa-hospital-user imagem-leito8"></i>
          <h2>Leito 8</h2>
        </div>
      </C.Card>
      ...
      {modalOpen && (
        <div className="modal-overlay8">
          <div className="modal8">
            <span className="close-button8" onClick={handleCloseModal}>
              &times;
            </span>
            <h1>Fábio Leon</h1>
